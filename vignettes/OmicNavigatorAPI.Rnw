...
\section{Studies for differential analsysis tab}
\label{sec:get-results-studies}

\textbf{Update: The endpoint \texttt{listStudies()} was removed in OmicNavigator 1.18.0}

Return the installed studies with differential expression results available.
...
\section{Models for differential analsysis tab}
...
\section{Tests for differential analsysis tab}
...
\section{Studies for enrichment analsysis tab}
\label{sec:get-enrichments-studies}

\textbf{Update: The endpoint \texttt{listStudies()} was removed in OmicNavigator 1.18.0}

Return the installed studies with enrichments available.
...
\section{Models for enrichment analsysis tab}
...
\section{Annotations for enrichment analsysis tab}
\label{sec:get-enrichments-models}
