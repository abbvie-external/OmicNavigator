...
[`plotStudy()`](#custom-plots) to create any custom plots. All the feature
...
Given a study and model, `getReportLink()` returns a link to a report file. This
can either be a URL or a relative path to a local file.
