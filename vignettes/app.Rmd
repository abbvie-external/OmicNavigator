...
abc <- addPlots(abc, OmicAnalyzer:::testPlots())
...
```{r plotStudy-plotBase, eval=TRUE}
plotStudy("ABC", "model_01", "feature_0001", "plotBase")
```

```{r plotStudy-plotGg, eval=TRUE}
plotStudy("ABC", "model_01", "feature_0001", "plotGg")
```
